...
export const Terminal = () => {
  ...
  return (
    <div className="touch-manipulation bg-zinc-950 p-0 font-mono leading-5 text-white">
        ...
        <form className="mb-20" onSubmit={handleSubmit}>
          <label className="flex items-start">
            ...
            <textarea
              ...
              className="h-48 w-full touch-manipulation resize-none items-start border-none bg-transparent font-mono outline-none"
              autoFocus
            />
          </label>
        </form>
