      ...
      <div className={`relative h-full w-full border-[0.25px] border-gray-300`}>
        <div className="absolute left-0 top-0 h-full w-full mix-blend-normal">
          <Silk
            speed={invert ? 10 : 2}
            scale={0.7}
            color={invert ? '#ffffff' : '#787878'}
            noiseIntensity={5}
            rotation={5.7}
          />
        </div>
        <div className="absolute left-0 top-0 h-full w-full mix-blend-darken">
          <Silk speed={invert ? 10 : 3} scale={0.4} color="#ffffff" noiseIntensity={30} rotation={0.5} />
        </div>
        <div className="relative z-20 h-full w-full pl-8 pt-7">
